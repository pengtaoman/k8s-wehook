...
// +kubebuilder:webhook:verbs=create;update,path=/validate-webapp-my-domain-v1-guestbook,mutating=false,failurePolicy=fail,groups=webapp.my.domain,resources=guestbooks,versions=v1,name=vguestbook.kb.io
...
func (r *Guestbook) ValidateCreate() error {
	...
	println("#################################  ValidateCreate ValidateCreate ValidateCreate####################")
	return nil
}
...
func (r *Guestbook) ValidateUpdate(old runtime.Object) error {
	...
	println("#################################  ValidateUpdate ValidateUpdate ValidateUpdate####################")
	return nil
}
